...
class SettingComponent extends Component
{
    ...
    public function update()
    {
        ...
        Setting::find($this->mt_id)->update([
            'code' => $this->code,
            'description' => $this->description,
            'order_by' => $this->order_by ?: null,
    ...
    {
        Setting::find($this->mt_id)->delete();
        $this->mt_id = null;
        $this->delete = null;
    }
    ...
    public function render()
    {
        ...
        $table = new Setting();
        $columns = $table->getTableColumns('settings');
        return view('livewire.setting-component', [
            'settings' => Setting::when($this->search, function ($q) use ($columns) {
