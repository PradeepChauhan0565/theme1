...
class SizeComponent extends Component
{
    ...
    public function render()
    {
        ...
        $table = new Size();
        $columns = $table->getTableColumns('sizes');
        return view('livewire.size-component', [
            'sizes' => Size::when($this->search, function ($q) use ($columns) {
