...
class DiamondShapeComponent extends Component
{
    use WithFileUploads;
    use WithPagination;
    ...
    public function update()
    {
        ...
        DiamondShape::find($this->sz_id)->update([
            'code' => $this->code,
            'description' => $this->description,
            'order_by' => $this->order_by ?: null,
    ...
    {
        DiamondShape::find($this->sz_id)->delete();
        $this->sz_id = null;
        $this->delete = null;
    }
    ...
    public function render()
    {
        ...
        $this->status = [];
        $datas = DiamondShape::all();
        foreach ($datas as $datas) {
            $this->status[$datas->id] = $datas->status;
        }

        $table = new DiamondShape();
        $columns = $table->getTableColumns('diamond_shapes');
        return view('livewire.diamond-shape-component', [
            'diamond_shapes' => DiamondShape::when($this->search, function ($q) use ($columns) {
