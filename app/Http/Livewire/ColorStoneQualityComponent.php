...
class ColorStoneQualityComponent extends Component
{
    use WithFileUploads;
    use WithPagination;
    ...
    public function edit($id)
    {
        $this->delete = null;
        $this->sz_id = $id;
        $datas = ColorStoneQuality::find($id);
    ...
    public function update()
    {
        ...
        ColorStoneQuality::find($this->sz_id)->update([
            'code' => $this->code,
            'description' => $this->description,
            'order_by' => $this->order_by ?: null,
    ...
    {
        ColorStoneQuality::find($this->sz_id)->delete();
        $this->sz_id = null;
        $this->delete = null;
    }
    ...
    public function statusChange($id)
    {
        ...
        ColorStoneQuality::find($id)->update([
            'status' => $d,
        ]);
    }
    ...
    public function render()
    {
        ...
        $this->status = [];
        $datas = ColorStoneQuality::all();
        foreach ($datas as $datas) {
            $this->status[$datas->id] = $datas->status;
        }

        $table = new ColorStoneQuality();
        $columns = $table->getTableColumns('color_stone_qualities');
        return view('livewire.color-stone-quality-component', [
            'color_stone_qualities' => ColorStoneQuality::when($this->search, function ($q) use ($columns) {
