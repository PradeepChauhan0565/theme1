...
class MetalComponent extends Component
{
    ...
    public function update()
    {
        ...
        MetalType::find($this->mt_id)->update([
            'code' => $this->code,
            'description' => $this->description,
            'order_by' => $this->order_by ?: null,
    ...
    {
        MetalType::find($this->mt_id)->delete();
        $this->mt_id = null;
        $this->delete = null;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.metal-component', [
            'metal_types' => MetalType::when($this->search, function ($q) use ($columns) {
