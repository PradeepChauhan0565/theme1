            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('hb_image')" style="cursor: pointer">Image <i
                                        class="fas fa-sort"></i>
                                </th>
        ...
        <div class="modal-dialog @if ($delete != 'delete') modal-xl @endif" role="document">
            <div class="modal-content">
                <div class="modal-header px-4">
                    <h5 class="modal-title" id="exampleModalLabel">Hero Banner</h5>
                ...
                <div class="modal-body  px-4">
                    @if ($delete != 'delete')
                        <div class="row pb-3 ">
                            <div class="col-lg-3 col-md-6 ">
                                ...
                                <div wire:loading wire:target="hb_image"><i
                    ...
                    @else
                        <span class="text-danger"> Are you sure to delete this banner?</span>
                    @endif
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary close-btn" data-dismiss="modal">Close</button>
                    @if ($banner_id && $delete == 'delete')
