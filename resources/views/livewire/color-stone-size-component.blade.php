        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Color Stone Sizes</h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('category_id')" style="cursor: pointer">Color Stone Sizes <i
                                        class="fas fa-sort"></i>
                                </th>
        ...
        <div class="modal-dialog @if ($delete != 'delete') modal-xl @endif" role="document">
            <div class="modal-content">
                <div class="modal-header px-4">
                    <h5 class="modal-title" id="exampleModalLabel">Color Stone Sizes</h5>
                    ...
                    @if ($delete != 'delete')
                        <div class="row pb-3 ">
                            <div class="col-lg-3 col-md-6 mb-2">
                                <label for="floatingInput" class="my-0" style="font-weight: 600">Color Stone Sizes
                                </label>
                                <input type="number" placeholder="Color Stone Sizes"
                                    class="col-lg rounded text-capitalize  my-0" {{ $disabled }} wire:model="code"
