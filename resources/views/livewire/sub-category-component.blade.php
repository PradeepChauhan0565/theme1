            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('category_id')" style="cursor: pointer">Category <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('categorytype_id')" style="cursor: pointer">Category Type <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('name')" style="cursor: pointer">Sub Category <i
                                        class="fas fa-sort"></i>
                                </th>
                        ...
                        <tbody>
                            @foreach ($subcategory as $item)
                                <tr>
                                    ...
                                    <td class="text-capitalize">{{ $item->categorytype->name ?? '' }}</td>
                                    <td class="text-capitalize">{{ $item->name }}</td>
                                    <td>{{ $item->description }}</td>
                                    <td>
                                        <img src="{{ asset('storage/subcategorybanners/' . $item->banner) }}"
                    ...
                    @if ($delete != 'delete')
                        <div class="row pb-3 ">
                            ...
                            <div class="col-lg-3">
                                ...
                                <select id="" class="col-lg rounded  my-0 text-capitalize"
                                    {{ $disabled }} wire:model="categorytype_id"
                                    style="outline: 0; padding:4px;border:1px solid black">
                                    <option value="">Select Category Type</option>
                                    @foreach ($catype as $item)
                                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
