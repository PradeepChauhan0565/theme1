            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('name')" style="cursor: pointer">Category Name <i
                                        class="fas fa-sort"></i>
                                </th>
                    ...
                    @if ($delete != 'delete')
                        <div class="row pb-3 ">
                            ...
                            <div class="col-lg-3 col-md-6 mb-2">
                                ...
                                <input type="text" placeholder="Description" id="editor"
                                    class="col-lg rounded  my-0" {{ $disabled }} wire:model="description"
                                    style="outline: 0; padding:4px;border:1px solid black">
                                @error('description')
                                    <span style="color:red">{{ $message }}</span>
                                @enderror
                                ...
                                @elseif($old_banner)
                                    ...
                                    <div class="position-relative m-2">
                                        <img style="width: 100px;"
                                            src="{{ asset('storage/categorybanners/' . $old_banner) }}"
                                            alt="">
                                        <div class="position-absolute"
