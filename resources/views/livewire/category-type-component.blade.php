            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('category_id')" style="cursor: pointer">Category Name <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('name')" style="cursor: pointer">Category Type <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('description')" style="cursor: pointer">Description<i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('banner')" style="cursor: pointer">Banner Image<i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('banner_title')" style="cursor: pointer">Banner Title <i
                                        class="fas fa-sort"></i>
                                </th>
                        ...
                        <tbody>
                            @foreach ($categorytypes as $item)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/categorytypebanners/' . $item->banner) }}"
        ...
        <div class="modal-dialog @if ($delete != 'delete') modal-xl @endif" role="document">
            <div class="modal-content">
                <div class="modal-header px-4">
                    <h5 class="modal-title" id="exampleModalLabel">Category Type</h5>
                        ...
                        <div class="row pb-3 ">
                            <div class="col-lg-3 col-md-6 mb-2">
                                ...
                                <select id="" class="col-lg rounded  my-0 text-capitalize" {{ $disabled }}
                                    wire:model="category_id" style="outline: 0; padding:4px;border:1px solid black">
                                ...
                                @elseif($old_banner)
                                    ...
                                    <div class="position-relative m-2">
                                        <img style="width: 100px;"
                                            src="{{ asset('storage/categorytypebanners/' . $old_banner) }}"
                                            alt="">
                                        <div class="position-absolute"
