        ...
        <div class="row mb-5">
            <div class="col-lg-4 ">
                <div class="position-relative product border">   
                        <a href="{{asset('/single')}}" target="_blank" style="text-decoration: none;"><img src="images/chill1.jpg" alt="" style="width: 100%;"> 
                            <div class="bg-white  p-2">
                                <p class="mt-2">Jewellery-dropdown-panel </p>
                                <p>Rs.18000</p>
                                <div class="text-center "style="background-color: #071d49;"><button class="p-1 border-0  text-white" style="background-color: #071d49;">Discover more</button></div>
                            </div> 
                        </a>
                        <div class="position-absolute  text-2xl" style="left:8px; top:2px; font-size:28px;"><i class="far fa-heart"></i></div>                   
                    <div class="position-absolute   top-0 left-0">
                        <div class=" details ">
                            ...
                            <div class="productwrapper  transition delay-700 duration-300 ease-in-out">
                                    ...
                                    <div class="position-absolute " style="left:-3px; top: 50%;  transform: translate(-50%);"><a class=" px-2 py-3" id="next" style="cursor: pointer; background-color:rgb(226, 230, 230);"><i class="fas fa-angle-left"></i></a> </div>
                                    <div class="position-absolute " style="right:-24px; top: 50%;  transform: translate(-50%);"><a class=" px-2 py-3" id="prev" style="cursor: pointer; background-color:rgb(226, 230, 230);"><i class="fas fa-angle-right"></i></a> </div>
                                    <div class="position-absolute   text-2xl " title="Add to wishlist" style="cursor:pointer; left:8px; top:2px; font-size:28px;"><i class="far fa-heart"></i></div> 
                            </div>
