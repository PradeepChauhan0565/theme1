        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Get Inspired</h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('gi_image')" style="cursor: pointer">Get Inspired Image <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('image_title')" style="cursor: pointer">Image Title <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('heading')" style="cursor: pointer">Heading <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('content')" style="cursor: pointer">Content <i
                                        class="fas fa-sort"></i>
                                </th>
                        ...
                        <tbody>
                            @foreach ($wedingidentity as $item)
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/getimages/' . $item->gi_image) }}"
        ...
        <div class="modal-dialog @if ($delete != 'delete') modal-xl @endif" role="document">
            <div class="modal-content">
                <div class="modal-header px-4">
                    <h5 class="modal-title" id="exampleModalLabel">Get Inspired</h5>
                        ...
                        <div class="row pb-3 ">
                            <div class="col-lg-3 col-md-6 ">
                                <label for="floatingInput" class="my-0 " style="font-weight: 600; color:#000000">Image
                                    <span style="color:#a19898; font-size:13px;">(1200px * 1200px)</span></label>
                                <input type="file" placeholder="Text" class="col-lg rounded  my-0"
                                    {{ $disabled }} wire:model="gi_image"
                                    style="outline: 0; padding:4px; border:1px solid black">
                                <div wire:loading wire:target="gi_image"><i
                                        class="fa fa-spinner fa-spin mt-2 ml-2"></i>Uploading...</div>

                                @if ($gi_image)
                                    Photo Preview:
                                    <img style="width:100px" src="{{ $gi_image->temporaryUrl() }}">
                                @elseif($old_gi_image)
                                    Old Image
                                    <img style="width: 100px;"
                                        src="{{ asset('storage/getimages/' . $old_gi_image) }}" alt="">
                                @endif
                                @error('gi_image')
                            ...
                            <div class="col-lg-3 col-md-6">
                                <label for="floatingInput" class="my-0" style="font-weight: 600">Image
                                    Title</label>
                                <input type="text" placeholder="Image Iitle" class="col-lg rounded  my-0"
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <input type="text" placeholder="Order By" class="col-lg rounded  my-0"
