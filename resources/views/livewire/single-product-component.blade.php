        ...
        <div class="container">
            ...
            <div class="row g-lg-5 mt-0">
                        ...
                        <div class="exzoom " id="exzoom">
                            <div class="exzoom_img_box " wire:ignore>
                                <ul class='exzoom_img_ul d-flex' style="padding-left: 0rem;">
                                    ...
                                    <li class=""><img src="{{ asset('storage/' . $product->image_url) }}"
                                            alt="" style="width: 100%; height:100%" /></li>
                                    @php
                                        $images1 = App\Models\ProductImage::where('product_id', $product->id)
                                            ->where('image_color_id', 'r')
                                            ->get();

                                    @endphp
                                    @foreach ($images1 as $key => $image1)
                                        <li class="btnfornext"><img src="{{ asset('storage/' . $image1->url) }}"
                                        ...
                                        @if ($image1->is_video != null)
                                            <li class=" product_list_ul"><img src="{{ asset('images/play.png') }}"
                                                ...
                                                <div class="bvideo-wrap ">
                                                    <video width="100%" height="100%" poster="" loop controls
                                                        muted autoplay>
                                                        <source src='{{ asset('storage/' . $image1->is_video) }}'
                                                            type='video/mp4'>
                                                    </video>
                                                </div>
                                            </li>
                                ...
                                <div style="position:absolute; top:3px; right:2px; z-index:9;">
                                    <div class="position-relative shares">
                                        ...
                                        <div id="share-buttons"
                                            style="position:absolute; top:45px; right:-5px; z-index:9;">

                                            <!-- facebook -->
                                            <a class="facebook" target="blank"><i
                                                    class="fab fa-facebook share-btn"></i></a>

                                            <a class="mail" target="blank"><i
                                                    class="fa-solid fa-envelope share-btn"></i></a>

                                            <!-- twitter -->
                                            <a class="twitter" target="blank"><i
                                                    class="fab fa-twitter share-btn"></i></a>

                                            <!-- linkedin -->
                                            <a class="linkedin" target="blank"><i
                                                    class="fab fa-linkedin share-btn"></i></a>

                                            <!-- reddit -->
                                            <a class="reddit" target="blank"><i class="fab fa-reddit share-btn"></i></a>

                                            <!-- whatsapp-->
                                            <a class="whatsapp" target="blank"><i
                                                    class="fab fa-whatsapp share-btn"></i></a>

                                            <!-- telegram-->
                                            <a class="telegram" target="blank"><i
                                                    class="fab fa-telegram share-btn"></i></a>
                ...
                <div class="col-lg-6 mt-4">
                    ...
                    <div class="mb-3">{{ $product->sku }}</div>
                    <div class="mb-3">Price <i class="fa-solid fa-indian-rupee-sign"></i>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($reviews > 0)
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a class="mx-2" style="color: #071d49;" href="#review"> {{ $reviews }}
                                    Review</a>
                        ...
                        @else
                            <div class="d-flex align-items-center">
                                ...
                                <a class="mx-2" style="color: #071d49;" href="#review"> No Review</a>
                            </div>
                        @endif
                    </div>
                    ...
                    @if ($product->product_size_id)
                        <div class="mb-3">
                            Size <select wire:change="ringSizeClick" wire:model="ring_size" class="px-2 py-1">
                    ...
                    <div class="mb-3">
                        <button wire:click="addToCart({{ $product->id }})"
                            class="py-2 text-center w-100 border-0 rounded" style="background-color: #071d49;">
                            <span wire:loading.remove wire:target="addToCart({{ $product->id }})"
                                style="background-color: #071d49;border:none;border-radius:5px; font-size:22px; color:#fff;">
                                Add to cart
                            </span>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex justify-content-end mt-2">
                                    ...
                                    <button wire:click="writeReview()"
                                        style="background-color:#071d49; color:white; padding:8px 20px;border:none;border-radius:5px; ">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
