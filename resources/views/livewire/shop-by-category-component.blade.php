        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Shop by Category</h3>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th wire:click="sort('sbc_image')" style="cursor: pointer">Image <i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('image_title')" style="cursor: pointer">Image title<i
                                        class="fas fa-sort"></i>
                                </th>
                                <th wire:click="sort('button_name')" style="cursor: pointer">Button Name <i
                                        class="fas fa-sort"></i>
                                </th>
        ...
        <div class="modal-dialog @if ($delete != 'delete') modal-xl @endif" role="document">
            <div class="modal-content">
                <div class="modal-header px-4">
                    <h5 class="modal-title" id="exampleModalLabel">Shop by Category</h5>
                        ...
                        <div class="row pb-3 ">
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <input type="text" placeholder="Button name" class="col-lg rounded  my-0"
                                    {{ $disabled }} wire:model="button_name"
                                    style="outline: 0; padding:4px;border:1px solid black">
                                @error('button_name')
                                    <span style="color:red">{{ $message }}</span>
                                @enderror
