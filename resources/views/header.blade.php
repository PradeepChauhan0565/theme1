...
*/
    ...
    <div class=" py-2  d-flex justify-content-between align-items-center px-2  d-block d-lg-none shadow"
        style="position: -webkit-sticky; position: sticky; top: 0; background-color:#fff; z-index: 1001;">
        <div class="position-relative d-flex align-items-center ">
            <a href="{{ asset('/') }}">
                <img src="{{ asset('public/images/logo1.png') }}" alt=""
                    style="position:absolute; top:-19px; width:45px; border-radius: 50%;  z-index:999;"></a>
            <div class="">
                <h3 style="margin-bottom:0px;line-height:0px;"><a href="{{ asset('/') }}" style="color:#071d49;">
                        New
                        Jewelry</a></h3>
            </div>
        </div>
        <div class=" d-flex align-items-center">
            <div class="mx-2" style="border-bottom: 2px solid #071d49;">
        ...
        <div class="account_menus">
            ...
            <div class="acount_btn p-3 ">
                ...
                <div class="d-flex justify-content-between">
                    <button class="px-3 py-1  border-0" style="background-color: #071d49; color:#fff;">Sign Up</button>
                    <button class="px-3 py-1 " style="border:1px solid #071d49;">Login</button>
                </div>
            </div>
        </div>
            ...
            <a href="{{ route('recent-view') }}" title="Recently Viewed" style="color:#071d49;">
                ...
                <svg data-name="browseing history" width="20" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <rect class="cls-1" x="15.43" y="7.76" width="1.29" height="6.47"
                        rx="0.65" ry="0.65" transform="translate(27.07 -5.07) rotate(90)" />
                </svg>
            </a>
        </div>

        <div class="position-relative right_menus"><a href="{{ route('wishlists') }}" style="color:#071d49;"
                title="Wishlist">
            ...
            <span
                style="font-size: 9px;cursor: pointer;  position:absolute; top:6px; left:50%;transform:translate(-50%)">
                6
            </span>
        </div>
        <div class=" position-relative right_menus"> <a class="social-icon " href="{{ route('cart') }}"
                ...
                {{--                               
                                        ...
                                        @endauth
                                        @guest --}}
                <span style="font-size: 9px; position:absolute; top:10px; left:50%;transform:translate(-50%)">
                    5
                </span>
                {{-- @endguest --}}
                </i>
        ...
        <button class="border-0 right_menus" type="button" data-bs-toggle="modal" data-bs-target="#leftModal"
            style="background-color:transparent;">
            <svg class="mobmenu position-relative" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="leftModalLabel"><a href="{{ asset('/') }}"
                            style="color:#071d49;"> New Jewels</a></h5>
    ...
    <div class="d-none d-lg-block shadow"
        ...
        <div class="" style="width:95%;margin:auto;">
            <div class="row d-flex   align-items-center">
                ...
                <div class="col-1 d-flex px-3  align-items-center">

                    <div style="border-bottom: 2px solid #071d49;">
                        <form class="main_search">
                            <input type="text" name="search" placeholder="Search..">
                        </form>
                    </div>
                        ...
                        <div class="right_menus">
                            <a href="{{ route('recent-view') }}" title="Recently Viewed">
                                <svg data-name="browseing history" width="24" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path class="cls-1"
                                        d="M13.49,0A10.93,10.93,0,0,0,2.62,9.29H.31c-.31,0-.4.2-.21.44l2.77,3.35a.43.43,0,0,0,.7,0L6.2,9.75c.19-.25.09-.45-.22-.45H3.93a9.72,9.72,0,1,1,2.39,8.24.66.66,0,0,0-.92,0,.65.65,0,0,0,0,.91A11,11,0,1,0,13.49,0Z" />
                                    <rect class="cls-1" x="12.84" y="3.88" width="1.29"
                                        height="7.76" rx="0.65" ry="0.65" />
                                    <rect class="cls-1" x="15.43" y="7.76" width="1.29"
                                        height="6.47" rx="0.65" ry="0.65"
